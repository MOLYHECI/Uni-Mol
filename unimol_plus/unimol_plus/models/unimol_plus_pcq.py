...
@register_model("unimol_plus_pcq")
...
@register_model_architecture("unimol_plus_pcq", "unimol_plus_pcq_base")
...
@register_model_architecture("unimol_plus_pcq", "unimol_plus_pcq_large")
def large_architecture(args):
    args.layers = getattr(args, "layers", 18)
    base_architecture(args)


@register_model_architecture("unimol_plus_pcq", "unimol_plus_pcq_small")
