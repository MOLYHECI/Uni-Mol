...
[ -z "${pos_loss_weight}" ] && pos_loss_weight=0.3
[ -z "${dist_loss_weight}" ] && dist_loss_weight=1.5
[ -z "${min_pos_loss_weight}" ] && min_pos_loss_weight=0.06
[ -z "${min_dist_loss_weight}" ] && min_dist_loss_weight=0.3
